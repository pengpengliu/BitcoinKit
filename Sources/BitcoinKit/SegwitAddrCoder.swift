...
//  
//
//  Created by Liu Pengpeng on 2020/6/9.
//

import Foundation

/// Segregated Witness Address encoder/decoder
internal class SegwitAddrCoder {
    private let bech32 = Bech32()
    
    /// Convert from one power-of-2 number base to another
    internal func convertBits(from: Int, to: Int, pad: Bool, idata: Data) throws -> Data {
        var acc: Int = 0
        var bits: Int = 0
        let maxv: Int = (1 << to) - 1
    ...
    internal func decode(hrp: String, addr: String) throws -> (version: Int, program: Data) {
    ...
    internal func encode(hrp: String, version: [UInt8], program: Data) throws -> String {
...
extension SegwitAddrCoder {
    internal enum CoderError: LocalizedError {
