...
internal class Bech32 {
    ...
    internal func encode(_ hrp: String, values: Data) -> String {
    ...
    internal func decode(_ str: String) throws -> (hrp: String, checksum: Data) {
...
extension Bech32 {
    internal enum DecodingError: LocalizedError {
        case nonUTF8String
